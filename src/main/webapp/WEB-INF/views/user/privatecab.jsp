...
<form:form class="form-horizontal" action="/privatecab" method="POST" modelAttribute="formm" id="formm"> 
<custom:hiddenInputs excludeParams="formm"/>
...
<div class="row dani">
<div class="col-sm-6 col-xs-6">Login</div><div class="row name">${user.username}</div> 
<div class="col-sm-6 col-xs-6">Phone number</div><div class="row name">${user.number}</div>
<div class="col-sm-6 col-xs-6">Email</div><div class="row name">${user.email}</div>
<div class="col-sm-6 col-xs-6">Card</div><div class="row name">${user.card}</div>
<div class="row"><br></div>
 <div class="col-sm-5 col-xs-5"></div>
<div class="col-md-5 col-xs-5"><a class="btn btn-warning" href="/privatecab/update/${user.id}">Оновити дані</a></div>
 </div>
 <div class="row">
 <br>
 <br>
